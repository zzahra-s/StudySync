...
('Dwayne Dantès', 'Spectator', 2, 'Stable', 3),
...
--Audrey and Klein are looking for missions where "At Risk" or "Lost Control" Beyonders are involved AND a high-risk artifact is connected.
...
join Beyonders as B
on A.GuardianID = B.BeyonderID
WHERE B.Status IN('Lost Control','High Risk')AND A.RiskLevel IN('High','Extreme')
